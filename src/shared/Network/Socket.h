...
public:
    ...
    void CloseSocket()
    {
        ...
        if (shutdownError)
            LOG_DEBUG("Socket::CloseSocket: {} errored when shutting down socket: {} ({})", GetRemoteIpAddress().to_string(),
...
protected:
    ...
    void SetNoDelay(bool enable)
    {
        ...
        if (err)
            LOG_DEBUG("Socket::SetNoDelay: failed to set_option(boost::asio::ip::tcp::no_delay) for {} - {} ({})",
